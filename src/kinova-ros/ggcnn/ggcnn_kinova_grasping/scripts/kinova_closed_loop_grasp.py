...
FINGER_TOPIC = rospy.get_param('~finger_topic', '/m1n6s200_driver/out/finger_position')
...
FINGER_VELO_TOPIC = rospy.get_param('~finger_velocity_topic', '/m1n6s200_driver/in/finger_velocity')
...
def command_callback(msg):
    ...
    if SERVO:
        ...
        if d[2] > 0.150:  # Min effective range of the realsense.
            ...
            gp_base = convert_pose(gp, CAMERA_FRAME, BASE_FRAME)
        ...
        gp_gripper = convert_pose(gp_base, BASE_FRAME, EE_FRAME)
...
if __name__ == '__main__':
    ...
    finger_sub = rospy.Subscriber(FINGER_TOPIC, kinova_msgs.msg.FingerPosition, finger_position_callback, queue_size=1)
    wrench_sub = rospy.Subscriber(WRENCH_TOPIC, geometry_msgs.msg.WrenchStamped, robot_wrench_callback, queue_size=1)
    command_sub = rospy.Subscriber(CMD_TOPIC, std_msgs.msg.Float32MultiArray, command_callback, queue_size=1)
    ...
    finger_pub = rospy.Publisher(FINGER_VELO_TOPIC, kinova_msgs.msg.FingerPosition, queue_size=1)
    r = rospy.Rate(100)
