...
bool operator==(const ::kinova_msgs::SetForceControlParamsRequest_<ContainerAllocator1> & lhs, const ::kinova_msgs::SetForceControlParamsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.inertia_linear == rhs.inertia_linear &&
