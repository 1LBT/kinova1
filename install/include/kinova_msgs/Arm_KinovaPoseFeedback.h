...
bool operator==(const ::kinova_msgs::Arm_KinovaPoseFeedback_<ContainerAllocator1> & lhs, const ::kinova_msgs::Arm_KinovaPoseFeedback_<ContainerAllocator2> & rhs)
{
  return lhs.kinova_pose == rhs.kinova_pose;
}
