...
bool operator==(const ::kinova_msgs::SetEndEffectorOffsetRequest_<ContainerAllocator1> & lhs, const ::kinova_msgs::SetEndEffectorOffsetRequest_<ContainerAllocator2> & rhs)
{
