...
bool operator==(const ::kinova_msgs::SetNullSpaceModeStateRequest_<ContainerAllocator1> & lhs, const ::kinova_msgs::SetNullSpaceModeStateRequest_<ContainerAllocator2> & rhs)
{
