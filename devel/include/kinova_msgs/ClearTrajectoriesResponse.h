...
bool operator==(const ::kinova_msgs::ClearTrajectoriesResponse_<ContainerAllocator1> & lhs, const ::kinova_msgs::ClearTrajectoriesResponse_<ContainerAllocator2> & rhs)
{
