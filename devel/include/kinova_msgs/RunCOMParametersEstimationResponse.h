...
bool operator==(const ::kinova_msgs::RunCOMParametersEstimationResponse_<ContainerAllocator1> & lhs, const ::kinova_msgs::RunCOMParametersEstimationResponse_<ContainerAllocator2> & rhs)
{
