...
struct StartResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _start_result_type;
...
bool operator==(const ::kinova_msgs::StartResponse_<ContainerAllocator1> & lhs, const ::kinova_msgs::StartResponse_<ContainerAllocator2> & rhs)
{
  return lhs.start_result == rhs.start_result;
}
...
struct Printer< ::kinova_msgs::StartResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kinova_msgs::StartResponse_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.start_result);
  }
};
