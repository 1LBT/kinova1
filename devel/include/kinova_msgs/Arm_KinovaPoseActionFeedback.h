...
bool operator==(const ::kinova_msgs::Arm_KinovaPoseActionFeedback_<ContainerAllocator1> & lhs, const ::kinova_msgs::Arm_KinovaPoseActionFeedback_<ContainerAllocator2> & rhs)
{
